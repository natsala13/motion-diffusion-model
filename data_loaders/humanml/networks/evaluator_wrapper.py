...
from data_loaders.interhuman.evaluator_models import InterCLIP
...
class EvaluatorIntergenWrapper(object):
    ...
    def _build_models(cfg):
        ...
        checkpoint = torch.load(pjoin('../InterGen/eval_model/interclip.ckpt'),map_location="cpu")
